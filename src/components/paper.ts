...
export const PAPERS: Paper[] = [
  { id: "cream", label: "Cream", bg: "#fbf8ec", line: "#d4dcc8", margin: "#b08a6a", ink: "#23301f", soft: "#57634f", tape: "#c9d6b8" },
  ...
  { id: "night", label: "Night", bg: "#242a24", line: "#394238", margin: "#7a6a52", ink: "#e9ead9", soft: "#b2b8ac", tape: "#6e9c6c" },
];
